    ...
    <LaptopFrame className="max-w-md lg:max-w-none" screenClassName="bg-[var(--bg-soft)]">
      <div className="p-4 md:p-5">
        ...
        <div className="space-y-3">
          <div className="rounded-[14px] border border-line bg-bg-soft/60 p-3.5">
            ...
            <div className="mt-3 h-1.5 overflow-hidden rounded-full bg-surface">
              <div className="h-full w-[92%] rounded-full bg-brand-strong" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-[14px] border border-line bg-surface p-3">
              <div className="flex items-center gap-2">
                <FileText size={14} className="text-brand-strong" />
              ...
              <div className="mt-2 flex gap-1">
                <span className="h-1.5 flex-1 rounded-full bg-brand-strong" />
                <span className="h-1.5 flex-1 rounded-full bg-brand-strong" />
                <span className="h-1.5 flex-1 rounded-full bg-brand-strong" />
            ...
            <div className="rounded-[14px] border border-line bg-surface p-3">
              <div className="flex items-center gap-2">
                <HeartHandshake size={14} className="text-brand-strong" />
      ...
      <section className="px-5 pb-20 pt-4 md:px-8 md:pb-28">
        <div className="mx-auto max-w-[920px] rounded-[1.75rem] border border-brand/20 bg-gradient-to-br from-brand-soft/80 via-surface to-surface px-6 py-12 text-center  md:px-12 md:py-14">
          ...
          <p className="mt-8 text-sm text-ink-muted">
            {t("Also see")}{" "}
            <Link href="/for-communities" className="font-medium text-brand-strong hover:underline">
              {t("For Residences")}
            </Link>
            .
          </p>
