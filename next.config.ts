...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/messages", destination: "/family/dashboard?view=messages", permanent: false },
      ...
      { source: "/family/messages", destination: "/family/dashboard?view=messages", permanent: false },
